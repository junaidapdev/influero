...
// The FAB's Quick Add sheet (ui-rules / ui-tokens): a 2×2 grid of Deal · Meeting
// · Payment · Snap report. Each tile navigates to the destination and (except
// Snap) signals it via location.state.quickAdd to pop its existing Add sheet —
// reusing every route's create flow rather than duplicating forms here.
